...
# bot informations
BOT_TOKEN = os.environ.get("AAHCSzl9PL30xsS_upk-IPviXaEyrLacMw0")
...
START_TEXT = """Hello {}, \
I am a channel/Group auto post telegram bot.

Made by @Cyberanonymous1996"""

BUTTONS = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                'Channel', url='https://telegram.me/Lootdailyoffers'),
            InlineKeyboardButton(
                'Feedback', url='https://telegram.me/cyberanonymous1996')
        ],
        [
            InlineKeyboardButton(
                'Source Code', url='https://github.com/abhishekverma1996/telegram-autopost')
        ]
    ]
)
